...
trait HasResponse
{
    ...
    {
        $response = [
            'status' => config('configMgs.status.failed'),
            'statuscode' => config('configMgs.code.failed'),
            'message' => $message
        ];
    ...
    {
        $response = [
            'status' => config('configMgs.status.success'),
            'statuscode' => config('configMgs.code.success'),
            'message' => $message
        ];
    ...
    public function serverErrorResponse($message, Exception $exception = null): JsonResponse
    {
        ...
        $response = [
            'status' => config('configMgs.status.failed'),
            'statuscode' => config('configMgs.code.server_error'),
            'message' => $message,
        ];
    ...
    public function notFoundResponse($message, array $data = []): JsonResponse
    {
        $response = [
            'status' => config('configMgs.status.failed'),
            'statuscode' => config('configMgs.code.not_found'),
            'message' => $message
        ];
    ...
    public function notAllowedResponse($message, array $data = []): JsonResponse
    {
        $response = [
            'status' => config('configMgs.status.failed'),
            'statuscode' => config('configMgs.code.not_allowed'),
            'message' => $message
        ];
    ...
    public function notExistResponse($message, array $data = []): JsonResponse
    {
        $response = [
            'status' => config('configMgs.status.failed'),
            'statuscode' => config('configMgs.code.notexist'),
            'message' => $message
        ];
    ...
    public function existsResponse($message, array $data = []): JsonResponse
    {
        $response = [
            'status' => config('configMgs.status.failed'),
            'statuscode' => config('configMgs.code.exists'),
            'message' => $message
        ];
    ...
    public function networkErrorResponse($message, array $data = []): JsonResponse
    {
        $response = [
            'status' => config('configMgs.status.failed'),
            'statuscode' => config('configMgs.code.network_error'),
            'message' => $message
        ];
    ...
    public function badRequestResponse($message, array $data = []): JsonResponse
    {
        $response = [
            'status' => config('configMgs.status.failed'),
            'statuscode' => config('configMgs.code.bad_request'),
            'message' => $message
        ];
